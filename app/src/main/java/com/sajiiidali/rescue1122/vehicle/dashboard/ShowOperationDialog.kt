...
class ShowOperationDialog : DialogFragment(R.layout.show_operation_dialog) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val bna1 = view.findViewById<AppCompatButton>(R.id.btn1)
        val bna2 = view.findViewById<AppCompatButton>(R.id.bna2)
        val bna3 = view.findViewById<AppCompatButton>(R.id.btn3)
        val bna4 = view.findViewById<AppCompatButton>(R.id.btn4)
        ...
        bna1.setOnClickListener {
            val directions = ShowOperationDialogDirections.actionShowOperationDialogToShowWebView("https://punjab.rescue1122.org/dashboard/vehicle/1209/edit")
            findNavController().navigate(directions)
        }
        bna2.setOnClickListener {
            val directions = ShowOperationDialogDirections.actionShowOperationDialogToShowWebView("https://punjab.rescue1122.org/dashboard/vehicle/1312/edit")
            findNavController().navigate(directions)
        }
        bna3.setOnClickListener {
            val directions = ShowOperationDialogDirections.actionShowOperationDialogToShowWebView("https://punjab.rescue1122.org/dashboard/vehicle/1191/edit")
            findNavController().navigate(directions)
        }
        bna4.setOnClickListener {
            val directions = ShowOperationDialogDirections.actionShowOperationDialogToShowWebView("https://punjab.rescue1122.org/dashboard/vehicle/1197/edit")
            findNavController().navigate(directions)
        }
